...
public class AddClassHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        System.out.println("In AddClassHandler handle");
...
//            System.out.println("req method is " + exchange.getRequestMethod().toLowerCase());
            if (exchange.getRequestMethod().toLowerCase().equals("get") || exchange.getRequestMethod().toLowerCase().equals("post")){
                ...
                //call service
                Boolean response = classDAO.addClass(dumbData.classID, dumbData.className, dumbData.colorName, dumbData.userID);
                //check for non error
                if(response != null){
            ...
            if(!success){
                ...
                String jsonStr = gson.toJson("add class failed");
                respBody.write(jsonStr);
                respBody.flush();
                respBody.close();
            }
